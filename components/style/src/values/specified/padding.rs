...
use crate::values::specified::{parse_shorthand_sides, LengthPercentage};
use crate::values::CssValueParse;
use crate::StyleParseErrorKind;
use cssparser::{ParseError, Parser};

pub(crate) fn parse_padding_shorthand_into<'i, 't>(
...
#[derive(Clone, Debug)]
pub struct Padding {
    pub(crate) length_percentage: LengthPercentage,
}
