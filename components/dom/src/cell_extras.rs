...
//! allowing limited access to a value without moving it out of the cell.
//!
//! This file is a direct copy-paste from [Kuchiki](https://github.com/kuchiki-rs/kuchiki/blob/master/src/cell_extras.rs).
//! Thanks to the authors of Kuchiki for their work.
//!
//! # Soundness
//!
//! These methods use `Cell::as_ptr` and `unsafe`.
...
//!   In particular, no method of a type parameter is called.
